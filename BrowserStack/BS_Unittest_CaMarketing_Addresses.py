...
import helpers as H
import my_url  # Import BrowserStack Key


class AddressesTests_Win11_Chrome(unittest.TestCase):
    ...
    def setUp(self):
        desired_cap = {
            ...
            'name': 'Test1_Win11_Chrome',  # test name
...
class Edge_AddressesTests(unittest.TestCase):
    ...
    def setUp(self):
        desired_cap = {
            ...
            'browser': 'edge',
            'browser_version': 'latest',
            'name': 'Test2_Win11_Edge',  # test name
            'build': 'browserstack-build-1'
        }
        url = my_url.url_v
        desired_cap['acceptSslCerts'] = True
